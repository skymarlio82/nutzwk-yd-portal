        ...
        <div class="row">
            ...
            <div class="col-md-9 ab_right">
                ...
                <div class="gyxm_c">
                    ...
                    <div class="wrap ayjs_01">
                        <div class="wrap_c">
                            <div class="ayln_01" style="margin-top: 0px;">
            ...
            success: function(data){
                if(data.data.list != null){
                    ...
                    $(data.data.list).each(function(i,event){
                        $(".ayln_01 ul").append('<li class="li1" channel_id="${param.menu_id}" parent_id="${param.parent_id}" article_id="'+event.id+'"><em>'+
                        '    <span class="sp1">'+event.title+'</span>'+
                        '       <span class="sp2">'+event.info+'</span>'+
                        '       <span class="sp3"><b></b></span>'+
                        '   </em></li>'
                        );
                    });

                    <%--$(document).on("click",".ayln_01 li",function(){--%>
                        <%--location.href="<%=basePath%>pages/jdgljh.jsp?parent_id="+$(this).attr("parent_id")+"&menu_id="+$(this).attr("channel_id")+"&article_id="+$(this).attr("article_id");--%>
                    <%--});--%>
                }
            }
        });
