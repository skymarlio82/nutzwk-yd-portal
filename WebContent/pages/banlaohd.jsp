    ...
    <div class="container ab_container">
        ...
        <div class="row">
            ...
            <div class="col-md-9 ab_right">
                ...
                <div class="report_c animated fadeInUpBig">
            ...
            success: function(data){
                if(data.data.list != null){
                    ...
                    $(data.data.list).each(function(i,event){
                        var link = "jdgljh.jsp?parent_id="+event.parent_id+"&menu_id="+event.channelid+"&article_id="+event.id;

                        if((i+1)%3 == 1){
                            $(".report_c").append('<div class="row data'+(Math.ceil((i+1)/3))+'">'+
                                '<div class="col-sm-4">'+
                                '       <a href="'+link+'" target="_blank"  data-src="">'+
