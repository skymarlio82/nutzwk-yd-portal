            ...
            success: function(data){
                if(data.data.list != null){
                    ...
                    $(data.data.list).each(function(i,event){
                        $(".gyxm_c ul").append('<li><a href="/pages/jdgljh.jsp?parent_id=${param.parent_id}&menu_id=${param.menu_id}&article_id='+event.id+'"' +
                            'target="_blank" ><span>'+event.title+'</span><i>'+event.opat+'</i></a></li>');
                    });
