    ...
    <div class="container ab_container">
        ...
        <div class="row">
            ...
            <div class="col-md-9 ab_right" >
                <div class="jd_cswy_c">
                    <div class="video_c">
                        <iframe frameborder="0" src="https://v.qq.com/iframe/player.html?vid=e066389buut&tiny=0&auto=0"></iframe>
                    </div>
                    <div>
                        <div class="video_list fadeIn">
                            <div class="swiper-wrapper" style="width:105%;">

                            </div>
                        <div class="cswy_paging swiper-pagination"></div>
                    </div>
                    </div>
                </div>
            </div>
...
<script src="../assets/js/custom/second.js"></script>
        ...
        $.ajax({
            ...
            success: function(data){
                if(data.data.list != null){
                    $(".video_list .swiper-wrapper").empty();
                    $(data.data.list).each(function(i,event){
                        $(".video_list .swiper-wrapper").append('<div class="swiper-slide" data-item="'+event.cms_params+'">'+
                            '    <a href="javascript:void(0);" data-src="'+event.cms_params+'">'+
                            '    <em style="background: #fff url('+event.picurl+') no-repeat center/cover;"><b></b></em>'+
